...
namespace Microsoft.Store.PartnerCenter.Explorer.Configuration.Bundling
{
    using System;
    ...
    public sealed class Bundler
    {
        ...
        /// </summary>
        private static Lazy<Bundler> instance = new Lazy<Bundler>(() => new Bundler());
        ...
        /// </summary>
        public static Bundler Instance => instance.Value;
