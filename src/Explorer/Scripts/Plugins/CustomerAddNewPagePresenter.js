Microsoft.WebPortal.CustomerAddNewPagePresenter = function (webPortal, feature, context) {
    ...
    this.base.constructor.call(this, webPortal, feature, "Home", "/Template/CustomerAddNew/");
...
$WebPortal.Helpers.inherit(Microsoft.WebPortal.CustomerAddNewPagePresenter, Microsoft.WebPortal.Core.TemplatePresenter);

Microsoft.WebPortal.CustomerAddNewPagePresenter.prototype.onActivate = function () {
    /// <summary>
    /// Called when the presenter is activated.
    /// </summary>
};

Microsoft.WebPortal.CustomerAddNewPagePresenter.prototype.onRender = function () {
    /// <summary>
...
Microsoft.WebPortal.CustomerAddNewPagePresenter.prototype.onShow = function () {
    /// <summary>
...
//@ sourceURL=CustomerAddNewPagePresenter.js